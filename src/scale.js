import { scaleLinear, scaleBand, scaleTime, scaleSequential, scaleDiverging } from "d3";
...
export const Scales = {
    ...
    time: (discreteValue, start_pos, end_pos) => {
        return scaleTime().range([start_pos, end_pos])
                .domain(discreteValue);
    },
